...
You can either use the pre-built Java JAR file for version 1.0.7 of the application, or download / clone source code from Github.
...
```sh
java -DNETLOG_HTTP_PORT=8701 -DNETLOG_DATABASE_FILE=D:/ham/netlog.db -jar netlog-1.0.7.jar
```
